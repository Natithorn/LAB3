...
namespace LAB3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            MaxGrade.Text = "คะแนนมากสุด 0";
            MinGrade.Text = "คะแนนมากสุด 0";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MaxGrade.Text = "คะแนนมากสุด " + Gradeall.Last().ToString();
            MinGrade.Text = "คะแนนน้อยสุด " + Gradeall.First().ToString();
